 ...
 */
	...
	function OrangeIdea_Popular_Posts_Widget() {
		...
		/* Create the widget. */		
		$this->WP_Widget( 'OrangeIdea_popular_post_widget', 'OrangeIdea: Popular Posts ', $widget_ops);
	}
...
function widget( $args, $instance ) {
	...
	<?php if ( $the_query->have_posts() ) : while ( $the_query->have_posts() ) : $the_query->the_post(); ?>
   		<?php $large_image_url = wp_get_attachment_image_src( get_post_thumbnail_id(), 'squre-for-widgets'); ?>
    	 ...
    	 <div class="oi_popular_widget_post_holder">
         	<div class="oi_popular_widget_post_image">
                ...
                <?php }else{?>
                <img class="img-responsive" src="<?php echo get_template_directory_uri(); ?>/framework/css/img/oi_format_standard_w.png" alt="<?php the_title(); ?>" >
				<?php };?>
                <div class="oi_popular_widget_views"><?php echo getPostViews(get_the_ID());?></div>
            </div>
