...
class OI_Instagram_Widget extends WP_Widget {
	...
	function OI_Instagram_Widget() {
		...
		/* Create the widget. */
		$this->WP_Widget( 'ct-instagram-widget', 'OrangeIdea: Instagram Widget ', $widget_ops);
	}
	...
	if ( $title )
		...
		<ul class="list-unstyled oi_instagram_widget_ul oi-instagram-<?php echo $time_id; ?> clearfix">
        </ul>
