 ...
 */
	...
	function OrangeIdea_Recent_Posts_Comments_Widget() {
		...
		/* Create the widget. */		
		$this->WP_Widget( 'OrangeIdea_recent_posts_comments_widget', 'OrangeIdea: Recent Comments ', $widget_ops);
	}
        ...
        <div class="oi_recent_comment_post_holder">
            <div class="oi_recent_comment_post">
                ...
                <div class="oi_post_content">
                    ...
                    <div class="oi_post_content_content"><a href="<?php echo get_permalink($comment->comment_post_ID); ?>"><?php echo substr($comment->comment_content,0,100).'...';  ?> </a></div>
                </div>
            </div>
        </div>	
