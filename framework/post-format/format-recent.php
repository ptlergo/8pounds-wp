...
<?php };?><div class="oi_page_post_slider_inner col-md-9">
	<div class="oi_page_post_slider_inner_content">
    	<div class="oi_blog_post_date">
            <div class="oi_date_d colored"><?php the_time('d F') ?> <span class="oi_year"><?php the_time('Y') ?></span> <span class="oi_recent_posts"><?php echo substr($slug, '0', '-2');?></span></div>
        </div>
